...
class WidgetTexto():
    ...
    def __init__(self, x, y, ancho, batch):
        ...
        self.layout = pyglet.text.layout.IncrementalTextLayout(self.documento, ancho, alto,
...
class WidgetColaReproduccion():
    ...
    def actualizar(self):
        ...
        a = pyglet.text.Label(text="{} - {}".format(cancion.obtener_titulo(), cancion.obtener_artista()))
